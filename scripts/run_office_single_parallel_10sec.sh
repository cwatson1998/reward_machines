#!/bin/bash
RESULTS_DIR="../my_results_10sec_original_$(date +%Y%m%d_%H%M%S)"
export RESULTS_DIR
NUM_TRIALS=10
...
run_iteration() {
	...
	# Single task
	/home/christopher/miniconda3/envs/hrm/bin/python run.py --alg=qlearning --env=Office-single-10sec-v0 --num_timesteps=1e5 --gamma=0.9 --log_path=$RESULTS_DIR/ql/office-single/M1/$i
	...
	/home/christopher/miniconda3/envs/hrm/bin/python run.py --alg=qlearning --env=Office-single-10sec-v0 --num_timesteps=1e5 --gamma=0.9 --log_path=$RESULTS_DIR/crm/office-single/M1/$i --use_crm
	...
	/home/christopher/miniconda3/envs/hrm/bin/python run.py --alg=hrm --env=Office-single-10sec-v0 --num_timesteps=1e5 --gamma=0.9 --log_path=$RESULTS_DIR/hrm/office-single/M1/$i
